  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('ListItems', [
      ...
      },
      {
        title: "Cake",
        currentRank: 6,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/144642.webp",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
      ...
      },
      {
        ...
        currentRank: 7,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/145683.webp",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
      ...
      },
      {
        title: "Tacos",
        currentRank: 8,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/23613.webp",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
      ...
      },
      {
        title: "Pizza",
        currentRank: 9,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/41134.jpg",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
      ...
      },
      {
        title: "Icecream",
        currentRank: 10,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/96228.jpg",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
      ...
      },
      {
        title: "Burger",
        currentRank: 11,
        imageLink: "https://topfunphotos.s3.us-west-1.amazonaws.com/topfunimages/favoritefood/96230.jpg",
        content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        listId: 2,
        userId: 1,
        createdAt: new Date(),
